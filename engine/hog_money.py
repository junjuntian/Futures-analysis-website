...
VARIETIES = {
    ...
    "JM": {
        ...
        "exit_mode": "inst",
        # **固定席位名单(DEC-125,2026-08-23 运营者拍板)**:国泰君安/东证/永安/浙商/东吴。
        # 「大席位里挑赚钱多」前 8 与现行择时前 5 重叠 4 家,运营者取前 5 把华泰换成浙商并固定。
        # 同策略只换席位组回放(run_fixed_groups.py):近一年 固定 +41.7%/夏普 1.85/回撤 −7.1%(37 笔),
        # 滚动组 +68.0%/2.35/−7.6%(29 笔);2026 +23.1% vs +30.8%;全样本 +114.4%/1.23/−20.7% vs
        # +244.0%/1.79/−13.9%。**三个窗口固定名单都弱于滚动组**,按运营者拍板上,如实记在 DEC-125。
        "fixed_members": ["国泰君安", "东证期货", "永安期货", "浙商期货", "东吴期货"],
        "fixed_since": "2026-08-23",
        "out": "jm_signals.json",
        "backtest": "固定5家 100 笔 +114.4%/夏普 1.23/回撤 −20.7%(2023-08 起;近一年 +41.7%/1.85/−7.1%)。"
                    "滚动 alpha 组同策略 72 笔 +244.0%/1.79/−13.9%(近一年 +68.0%/2.35/−7.6%)"
                    "(DEC-125 换固定名单,三窗口皆弱于滚动,运营者拍板;DEC-116/117 开做多 + 机构出场)",
    },
}
