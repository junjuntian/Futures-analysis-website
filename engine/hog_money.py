...
VARIETIES = {
    ...
    "I": {
        ...
        "backtest": "**主引擎是通用共振口径,铁矿石没做过任何专项验收,而且这条线"
                    "是亏的、风险调整后还不如什么都不做**。上方那个风险警示框里的"
                    "四条是实算的,不是显示故障 —— 以那里的数为准。"
                    "上线是为了把品种页开出来(DEC-178,运营者要求「跟焦煤生猪一样"
                    "的界面」),**今日信号那一格现在不该照着下单**。"
                    "这个品种真正有证据的是第二引擎那条(跟永安),而它的第七道"
                    "闸门也没过 —— 见 REPORT_I_FOLLOW_v1 与那张卡上的丑话",
    },
    "SA": {
