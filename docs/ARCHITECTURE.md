...
- 第一批一次覆盖 DCE、SHFE、CZCE、GFEX、CFFEX；东方财富按 `DEC-043` 承担席位兜底（排在全部官方源之后），并按 `DEC-045` 承担大商所的行情与合约目录——大商所官方接口自 2026-08-02 起全线 412，`DEC-041` 当初选的新浪兜底对其在市合约只覆盖 44%，两者均已退役，其余二手数据源不进入第一批。
