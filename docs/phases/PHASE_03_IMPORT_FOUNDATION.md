...
本阶段不实现行情分析、套利统计、交易持仓、外部采集、AI 或自动回测。
...
- 不实现套利、交易、AI、外部采集、行情分析、自动回测或图表能力。
...
- 冲突候选人工解决/提升为正式记录。
- 完整前端导入中心改版。
- 行情、交易、持仓、套利、图表、外部采集、AI、回测或自动交易。
...
- 未实现 cancel、dead-letter replay、回滚、补偿批次、`import_row_changes`、行情、交易、套利、图表、AI 或外部数据采集。
...
- 明确排除 cancel、人工 dead-letter replay、冲突候选人工合并、套利/交易/持仓/席位/图表、外部采集、AI 和自动回测。
